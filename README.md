...
| Tonal Neutral Point            | 0.30            | Scene brightness treated as "average", where neither Lift nor Pull does anything. Below it the Lift sliders apply, above it the Pull sliders apply. Governs both groups. |
