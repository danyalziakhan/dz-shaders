...
| Dark Scene Fade Threshold      | 0.05            | Scene brightness below which the Dark Scene Fade reaches full strength. The effect ramps smoothly from black up to this value.                           |
...
| Adaptation Floor               | 0.03            | Lower clamp on the measured scene brightness. Stops a fade-to-black or a wall of shadow from dragging the exposure to the floor.                         |
| Adaptation Ceiling             | 0.85            | Upper clamp on the measured scene brightness. Stops a white flash from railing the exposure and crushing the scene dark afterwards.                      |
